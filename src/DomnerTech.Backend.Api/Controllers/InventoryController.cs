    ...
    IErrorMessageLocalizeRepo errorMessageLocalizeRepo) : BaseApiController(errorMessageLocalizeRepo)
{
    ...
    [ProducesResponseType(typeof(BaseResponse<List<StockDto>>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(BaseResponse<List<StockDto>>), StatusCodes.Status404NotFound)]
